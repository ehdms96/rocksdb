...
#./db_bench --db=/mnt/f2fs/dbbench --benchmarks=fillrandom,stats --use_direct_io_for_flush_and_compaction --num=24500000 --key_size=20 --value_size=800 --max_background_jobs=8 --write_buffer_size=134217728 --target_file_size_base=134217728 --stats_interval_seconds=1
#./db_bench --db=/mnt/f2fs/dbbench --benchmarks=fillrandom,stats --use_direct_io_for_flush_and_compaction --compression_type=none --num=12000000 --key_size=20 --value_size=800 --max_background_jobs=8 --write_buffer_size=134217728 --target_file_size_base=134217728 --stats_interval_seconds=1
